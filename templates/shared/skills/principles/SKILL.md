---
name: principles
description: Use when deciding scope, simplicity, or whether code should be written at all. Covers the simplicity ladder, YAGNI, surgical changes, and fixing root causes.
---
...
- **Standards, security, and review**: Follow the `standards`, `security`, and `review` skills.
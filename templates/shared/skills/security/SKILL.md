---
name: security
description: Use when handling secrets, untrusted input, queries, or output. Covers validation, injection defense, and keeping credentials out of code and logs.
---

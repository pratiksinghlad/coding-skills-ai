---
name: review
description: Use when reviewing a diff or verifying a change before it is done. Covers correctness, readability, architecture, security, performance, and test checks.
---
